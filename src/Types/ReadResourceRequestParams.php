...
class ReadResourceRequestParams
{
     ...
     * @return ReadResourceRequestParams Created instance
     * @throws \InvalidArgumentException
     */
    public static function buildFromInput(array|object $input, bool $validate = true) : ReadResourceRequestParams
    {
