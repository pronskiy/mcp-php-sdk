...
If present, there may be more results available.',
     ...
     * @return ListResourcesResult Created instance
     * @throws \InvalidArgumentException
     */
    public static function buildFromInput(array|object $input, bool $validate = true) : ListResourcesResult
    {
        ...
        $resources = array_map(fn(mixed $i): mixed => $i, $input->{'resources'});

        $obj = new self($resources);
        $obj->Meta = $Meta;
    ...
    public function toJson() : array
    {
        ...
        $output['resources'] = array_map(fn(mixed $i): mixed => $i, $this->resources);
