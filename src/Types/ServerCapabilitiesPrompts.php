...
class ServerCapabilitiesPrompts
{
     ...
     * @return ServerCapabilitiesPrompts Created instance
     * @throws \InvalidArgumentException
     */
    public static function buildFromInput(array|object $input, bool $validate = true) : ServerCapabilitiesPrompts
    {
