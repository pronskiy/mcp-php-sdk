...
class PromptListChangedNotification
{
     ...
     * @return PromptListChangedNotification Created instance
     * @throws \InvalidArgumentException
     */
    public static function buildFromInput(array|object $input, bool $validate = true) : PromptListChangedNotification
    {
